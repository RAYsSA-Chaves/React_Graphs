...
function ExternalLabel(props) {
    ...
    const comprimentoTextoEstimado = texto.lenght * (tamanhoFonte * 1.3);
    const comprimentoLinha = (comprimentoTextoEstimado / 2) + 50;

    // Ponto final da linha horizontal (direita ou esquerda)
    let endX;
    if (cos >= 0) {
        endX = midX + comprimentoLinha; // direita
    }
    else {
        endX = midX - comprimentoLinha; // esquerda
    }
